...
class Population:
    ...
    def __init__(self, model,
        ...
        if attr_pd_df is None:
            ...
            attr_pd_df = pd.DataFrame(attr_pd_arr,
        ...
        if protection_pm_df is None:
            protection_pm_arr = np.zeros((model.dim['p'],
                                          model.dim['m']))
            ...
            protection_pm_df = pd.DataFrame(protection_pm_arr,
                                            index=model.label['Population'],
        ...
        if prot_demand_mn_df is None:
            prot_demand_mn_arr = np.array([[0, 1],
                                           [0, 2],
                                           [0, 2],
                                           [0.1, 3],
                                           [0.2, 4],
            ...
            prot_demand_mn_df = pd.DataFrame(prot_demand_mn_arr,
