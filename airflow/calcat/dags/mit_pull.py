...
# constants
URL: str = (
    "https://raw.githubusercontent.com/COVIDAnalytics/"
    + "website/master/data/predicted/Global.csv"
)
...
def build_paths(agg: str, loc: str):
    """Return list of str paths for agg and loc."""
