...
class Data(BaseLog):
    ...
    As a convenience is the key is looks like a debug fstring, we will take just
    the first half, so if the string looks like "self.foo.variable=123" which was
    generated by sending f"{self.foo.variable=}" then we just slice it off and get "variable"
    """
